...
const initialControls: ControlsState = {
	...
	projectionMode: "local", // was global by default but no gnx/gny atm
	showNeighbours: true,
...
export const [controls, setControls] = makePersisted(createStore<ControlsState>(initialControls), { name: "controls" });
