...
export function buildColorMap(values: string[], topN = 24): Map<string, [number, number, number, number]> {
...
export function buildCssColorMap(values: string[], topN = 24): Map<string, CssClusterColor> {
...
export function pickForeground(r: number, g: number, b: number): string {
